...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float4 lookup1 = tex2D(fs_param_Texture, psin.TexCoords);
    float4 lookup2 = tex2D(fs_param_Texture, psin.TexCoords / 50);
    float4 lookup3 = tex2D(fs_param_Texture, psin.TexCoords / 150);
    output = (lookup1 + float4(1, 1, 1, 1)) * (lookup2 + float4(1, 1, 1, 1)) / 8 + lookup3 / 4;
    output *= psin.Color;
