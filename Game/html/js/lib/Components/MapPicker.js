define(['lodash', 'react', 'react-bootstrap', 'interop', 'events', 'ui', 'Components/Chat'], function(_, React, ReactBootstrap, interop, events, ui, Chat) {
    ...
    var MapEntry = React.createClass({displayName: "MapEntry",
        render: function() {
            return (
                React.createElement(ListGroupItem, {href: "#", onClick: this.props.onPick, onDoubleClick: this.props.onConfirm}, 
        ...
        render: function() {
            ...
            var mapEntrees = _.map(this.state.maps, function(map) {
                if (_.isObject(map)) {
                    ...
                    return (
                        React.createElement(MapEntry, {name: map, onPick: onPick, onConfirm: _this.onConfirm})
                    );
                }
            });
