define(['lodash', 'react', 'react-addons', 'react-bootstrap', 'interop'], function(_, React, ReactAddons, ReactBootstrap, interop) {
    ...
    var UiImage = React.createClass({
        ...
        renderAt: function() {
            ...
            var img = <div className="UiImage" style={style} onMouseEnter={this.onEnter} onMouseLeave={this.onLeave} />;
    ...
    var ChatInput = React.createClass({
        ...
        renderAt: function() {
            return (
                <Input value={this.state.value} ref="input" type="text" addonBefore="All" onChange={this.onTextChange} onKeyDown={this.onKeyDown}/>
            );
        },
    });
            ...
            return (
                <div>
                    ...
                    <Div pos={pos(15,0)}>
                        ...
                        <ChatBox pos={pos(.38, 60)} size={width(38)}/>
