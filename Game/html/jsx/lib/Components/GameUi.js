define(['lodash', 'react', 'react-addons', 'react-bootstrap', 'interop'], function(_, React, ReactAddons, ReactBootstrap, interop) {
    ...
    var UiImage = React.createClass({
        ...
        renderAt: function() {
            ...
            return (
                <div style={divStyle} onMouseOver={this.props.nonBlocking ? null : onOver} onMouseLeave={this.props.nonBlocking ? null : onLeave}>
                    {body}
                </div>
            );
        }
        ...
        renderAt: function() {
            ...
            return (
                <Div pos={pos(0,0,'relative')} size={size(7,100)} style={{'float':'left','display':'inline-block'}}>
                    ...
                    <Div nonBlocking pos={pos(-16,8.5)} size={width(100)} style={pStyle}><p>100</p></Div>
                </Div>
            );
        },
    });
