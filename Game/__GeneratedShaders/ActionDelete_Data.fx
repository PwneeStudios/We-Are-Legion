...
bool Game__SimShader__SomethingSelected__Game_data(float4 u)
{
    return Game__SimShader__Something__Game_data(u) && Game__SimShader__selected__Game_data(u);
}
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__SomethingSelected__Game_data(here))
    {
