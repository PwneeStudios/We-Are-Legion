...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    __FinalOutput.Color = Game__SimShader__SomethingFakeSelected__data(tex2D(fs_param_Data, psin.TexCoords + (-float2(0.25,0.25) + float2(0, 0)) * fs_param_Data_dxdy)) ? Game__SimShader__pack_vec2__vec2(uv) : float4(1, 1, 1, 1);
