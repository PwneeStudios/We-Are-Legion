...
float Game__SimShader__unpack_val__FragSharpFramework_vec3(float3 packed)
{
    float coord = 0;
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float count_3byte = Game__SimShader__unpack_val__FragSharpFramework_vec3(TL.xyz) + Game__SimShader__unpack_val__FragSharpFramework_vec3(TR.xyz) + Game__SimShader__unpack_val__FragSharpFramework_vec3(BL.xyz) + Game__SimShader__unpack_val__FragSharpFramework_vec3(BR.xyz);
    float count_1byte = TL.w + TR.w + BL.w + BR.w;
    float4 output = float4(0, 0, 0, 0);
    output.xyz = Game__SimShader__pack_coord_3byte__float(count_3byte);
