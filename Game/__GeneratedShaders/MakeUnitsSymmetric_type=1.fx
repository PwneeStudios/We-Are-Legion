...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float4 copy = tex2D(fs_param_Units, psin.TexCoords + (-float2(0.25,0.25) + float2(0, 0) - Game__MakeSymmetricBase__QuadMirrorShift__Sampler__vec2__Single(psin, fs_param_Units, fs_param_Units_size, fs_param_Units_dxdy, pos, 1)) * fs_param_Units_dxdy);
