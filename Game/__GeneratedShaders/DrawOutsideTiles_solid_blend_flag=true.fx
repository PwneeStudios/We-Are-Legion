...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    here.b = 0.09803922;
    here.r = 0.01960784;
    output += Game__DrawTiles__Sprite__Game_tile__FragSharpFramework_vec2__FragSharpFramework_PointSampler__bool__float(psin, here, subcell_pos, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy, true, fs_param_solid_blend);
