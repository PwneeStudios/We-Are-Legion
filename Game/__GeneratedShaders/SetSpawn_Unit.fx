...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    {
        float4 barracks = tex2D(fs_param_Unit, psin.TexCoords + (Game__SimShader__dir_to_vec__float(Game__SimShader__Reverse__float(data_here.r))) * fs_param_Unit_dxdy);
    ...
    if (Game__SimShader__Something__Game_data(data_here) && abs(data_here.a - 0.01960784) < .001)
    {
        ...
        unit_here.b = Game__SimShader__GetPlayerVal__Game_PlayerTuple__float(fs_param_Teams, magic_here.g);
