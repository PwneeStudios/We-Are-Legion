...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__Something__Game_building(building_here))
    {
        ...
        {
            float frame = 0;
            output += Game__DrawBuildings__Sprite__float__Game_building__Game_unit__FragSharpFramework_vec2__float__FragSharpFramework_PointSampler(psin, 0.007843138, building_here, unit_here, subcell_pos, frame, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy);
        }
    }
    __FinalOutput.Color = output;
    return __FinalOutput;
