...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__Something__building(building_here))
    {
        ...
        {
            float frame = 0;
            output += Game__DrawBuildings__Sprite__Single__building__unit__vec2__Single__PointSampler(psin, 0, building_here, unit_here, subcell_pos, frame, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy);
        }
    }
    __FinalOutput.Color = output;
    return __FinalOutput;
