...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (abs(unit_here.g - 0.01176471) < .001 && Game__SimShader__Something__data(data_here) && Game__SimShader__IsUnit__unit(unit_here) && Game__SimShader__selected__data(data_here) && fs_param_action < 0.04705882 - .001)
    {
