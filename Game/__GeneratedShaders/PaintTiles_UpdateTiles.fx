...
void Game__PaintTiles_UpdateTiles__GrassTreeInterface__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile(inout float4 here, inout float4 right, inout float4 up, inout float4 left, inout float4 down, inout float4 up_right, inout float4 up_left, inout float4 down_right, inout float4 down_left)
{
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    {
        Game__PaintTiles_UpdateTiles__DirtGrassInterface__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile(here, right, up, left, down, up_right, up_left, down_right, down_left);
    }
    else
    {
        if (abs(here.r - 0.003921569) < .001 || abs(here.r - 0.01960784) < .001)
        {
            Game__PaintTiles_UpdateTiles__GrassTreeInterface__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile__Game_tile(here, right, up, left, down, up_right, up_left, down_right, down_left);
        }
    }
