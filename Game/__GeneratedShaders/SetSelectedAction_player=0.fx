...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (abs(unit_here.g - 0) < .001 && Game__SimShader__Something__Game_data(data_here) && Game__SimShader__IsUnit__Game_unit(unit_here) && Game__SimShader__selected__Game_data(data_here) && fs_param_action < 0.04705882 - .001)
    {
