...
float2 FragSharpFramework__FragSharpStd__max__vec2__vec2__vec2__vec2(float2 a, float2 b, float2 c, float2 d)
{
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    __FinalOutput.Color = Game__SimShader__pack_vec2__vec2(FragSharpFramework__FragSharpStd__max__vec2__vec2__vec2__vec2(TL, TR, BL, BR));
