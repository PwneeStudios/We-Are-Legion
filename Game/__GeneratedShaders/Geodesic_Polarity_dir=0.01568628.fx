...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float dist_here = Game__SimShader__unpack_val__FragSharpFramework_vec2(info_here.xy), dist_shift = Game__SimShader__unpack_val__FragSharpFramework_vec2(info_shift.xy), circum = Game__SimShader__unpack_val__FragSharpFramework_vec2(info_here.zw);
