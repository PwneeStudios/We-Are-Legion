...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (antimagic.r > 0.0 + .0019 && abs(0.01568628 - 0.003921569) > .0019)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    if (antimagic.g > 0.0 + .0019 && abs(0.01568628 - 0.007843138) > .0019)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    if (antimagic.b > 0.0 + .0019 && abs(0.01568628 - 0.01176471) > .0019)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    if (antimagic.a > 0.0 + .0019 && abs(0.01568628 - 0.01568628) > .0019)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    ...
    {
        if (Game__UnitDistribution__Contains__Single__vec2__Field(psin, 1, psin.TexCoords * fs_param_Select_size, fs_param_Corpses, fs_param_Corpses_size, fs_param_Corpses_dxdy))
        {
