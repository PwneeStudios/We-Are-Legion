...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__Something__data(data_here))
    {
        ...
        if (abs(unit_here.r - 0.02352941) < .001 && !((Game__SimShader__IsUnit__Single(0.02352941) && abs(unit_here.a - 0.07058824) < .001)) && !((Game__SimShader__IsBuilding__Single(0.02352941) && !(Game__SimShader__IsCenter__building(data_here)))))
        {
