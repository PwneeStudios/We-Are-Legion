...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    else
    {
        ...
        {
            if (abs(0.007843138 - 0.01568628) < .0019)
            {
            ...
            {
                if (abs(0.007843138 - 0.01176471) < .0019)
                {
    ...
    if (geo_here.r > 0 + .0019 && Game__SimShader__IsBlockingTile__tile(tex2D(fs_param_Tiles, psin.TexCoords + (-float2(0.25,0.25) + Game__SimShader__dir_to_vec__Single(0.007843138)) * fs_param_Tiles_dxdy)))
    {
        output = dirward_here;
