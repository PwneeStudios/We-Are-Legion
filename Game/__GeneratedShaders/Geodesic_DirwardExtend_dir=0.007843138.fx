...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (geo_here.r > 0 + .001 && Game__SimShader__IsBlockingTile__tile(tex2D(fs_param_Tiles, psin.TexCoords + (Game__SimShader__dir_to_vec__Single(0.007843138)) * fs_param_Tiles_dxdy)))
    {
        output = dirward_here;
