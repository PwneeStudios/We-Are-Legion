...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__Something__data(data_here))
    {
        ...
        if (abs(unit_here.r - 0.01568628) < .0019 && !((Game__SimShader__IsUnit__Single(0.01568628) && abs(unit_here.a - 0.07058824) < .0019)) && !((Game__SimShader__IsBuilding__Single(0.01568628) && !(Game__SimShader__IsCenter__building(data_here)))))
        {
