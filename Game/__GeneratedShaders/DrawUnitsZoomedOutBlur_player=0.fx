...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    output = 0.5 * 0.25 * (Game__DrawUnits__Presence__Single__data__unit(0, data_right, unit_right) + Game__DrawUnits__Presence__Single__data__unit(0, data_up, unit_up) + Game__DrawUnits__Presence__Single__data__unit(0, data_left, unit_left) + Game__DrawUnits__Presence__Single__data__unit(0, data_down, unit_down)) + 0.5 * Game__DrawUnits__Presence__Single__data__unit(0, data_here, unit_here);
