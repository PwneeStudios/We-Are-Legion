...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    {
        if (Game__UnitDistribution__Contains__float__FragSharpFramework_vec2__FragSharpFramework_Field_Game_corpse_(psin, 1, psin.TexCoords * fs_param_Select_size, fs_param_Corpses, fs_param_Corpses_size, fs_param_Corpses_dxdy))
        {
