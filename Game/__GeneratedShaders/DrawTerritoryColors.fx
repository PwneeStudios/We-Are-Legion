...
float4 Game__TerritoryColor__Get__float(VertexToPixel psin, float player)
{
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    {
        clr = Game__TerritoryColor__Get__float(psin, 0.003921569 + ((int)dist.x / 100));
    }
    if (dist.y < 0.02745098 - .001 && dist.y < enemy_dist.y - .001)
    {
        clr = Game__TerritoryColor__Get__float(psin, 0.007843138 + ((int)dist.x / 100));
    }
    if (dist.z < 0.02745098 - .001 && dist.z < enemy_dist.z - .001)
    {
        clr = Game__TerritoryColor__Get__float(psin, 0.01176471 + ((int)dist.x / 100));
    }
    if (dist.w < 0.02745098 - .001 && dist.w < enemy_dist.w - .001)
    {
        clr = Game__TerritoryColor__Get__float(psin, 0.01568628 + ((int)dist.x / 100));
    }
    clr *= _blend;
