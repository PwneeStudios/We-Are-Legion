...
float4 Game__TerritoryColor__Player1()
{
    return float4(0.2705882, 0.2078431, 0.6431373, 1.0);
}

float4 Game__TerritoryColor__Player2()
{
    return float4(0.4784314, 0.172549, 0.1372549, 1.0);
}

float4 Game__TerritoryColor__Player3()
{
    return float4(0.2470588, 0.5058824, 0.6117647, 1.0);
}

float4 Game__TerritoryColor__Player4()
{
