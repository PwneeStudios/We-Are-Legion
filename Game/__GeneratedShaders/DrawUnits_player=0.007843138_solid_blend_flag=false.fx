...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__Something__data(cur) && abs(cur.g - 0.003921569) < .0019)
    {
        ...
        output += Game__DrawUnits__Sprite__Single__data__unit__vec2__Single__TextureSampler__Single__Single__Boolean__Single(psin, 0.007843138, pre, pre_unit, subcell_pos, frame, fs_param_UnitTexture, fs_param_UnitTexture_size, fs_param_UnitTexture_dxdy, fs_param_selection_blend, fs_param_selection_size, false, fs_param_solid_blend);
    }
    else
    {
        ...
        if (Game__SimShader__IsValid__Single(cur.r))
        {
            ...
            cur.r = prior_dir;
            float2 offset = (1 - fs_param_s) * Game__SimShader__direction_to_vec__Single(prior_dir);
            output += Game__DrawUnits__Sprite__Single__data__unit__vec2__Single__TextureSampler__Single__Single__Boolean__Single(psin, 0.007843138, cur, cur_unit, subcell_pos + offset, frame, fs_param_UnitTexture, fs_param_UnitTexture_size, fs_param_UnitTexture_dxdy, fs_param_selection_blend, fs_param_selection_size, false, fs_param_solid_blend);
        }
        if (Game__SimShader__IsValid__Single(pre.r) && output.a < 0.025 - .0019)
        {
            ...
            output += Game__DrawUnits__Sprite__Single__data__unit__vec2__Single__TextureSampler__Single__Single__Boolean__Single(psin, 0.007843138, pre, pre_unit, subcell_pos + offset, frame, fs_param_UnitTexture, fs_param_UnitTexture_size, fs_param_UnitTexture_dxdy, fs_param_selection_blend, fs_param_selection_size, false, fs_param_solid_blend);
        }
    }
