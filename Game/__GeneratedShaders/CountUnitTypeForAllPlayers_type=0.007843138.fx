...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Game__SimShader__Something__Game_data(data_here))
    {
        ...
        if (abs(unit_here.r - 0.007843138) < .001 && !((Game__SimShader__IsUnit__float(0.007843138) && abs(unit_here.a - 0.07058824) < .001)) && !((Game__SimShader__IsBuilding__float(0.007843138) && !(Game__SimShader__IsCenter__Game_building(data_here)))))
        {
