...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (antimagic.r > 0.0 + .001 && abs(0.01176471 - 0.003921569) > .001)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    if (antimagic.g > 0.0 + .001 && abs(0.01176471 - 0.007843138) > .001)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    if (antimagic.b > 0.0 + .001 && abs(0.01176471 - 0.01176471) > .001)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    if (antimagic.a > 0.0 + .001 && abs(0.01176471 - 0.01568628) > .001)
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
