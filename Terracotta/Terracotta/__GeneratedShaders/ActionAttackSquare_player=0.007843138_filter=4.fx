...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (abs(0.007843138 - unit_here.g) < .001 && Terracotta__SimShader__selected__Terracotta_data(data_here) && Terracotta__SelectionFilter__FilterHasUnit__float__float(4, unit_here.r))
    {
