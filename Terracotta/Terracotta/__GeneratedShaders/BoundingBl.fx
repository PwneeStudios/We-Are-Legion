...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    __FinalOutput.Color = Terracotta__SimShader__SomethingSelected__Terracotta_data(tex2D(fs_param_Units, psin.TexCoords + (float2(0, 0)) * fs_param_Units_dxdy)) ? Terracotta__SimShader__pack_vec2__FragSharpFramework_vec2(uv) : float4(1, 1, 1, 1);
