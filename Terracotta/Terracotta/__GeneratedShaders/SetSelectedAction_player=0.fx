...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (abs(unit_here.g - 0) < .001 && Terracotta__SimShader__Something__Terracotta_data(data_here) && Terracotta__SimShader__IsUnit__Terracotta_unit(unit_here) && Terracotta__SimShader__selected__Terracotta_data(data_here) && fs_param_action < 0.04705882 - .001)
    {
