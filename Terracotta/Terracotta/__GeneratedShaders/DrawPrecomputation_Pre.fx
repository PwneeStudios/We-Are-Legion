...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float selected_offset = Terracotta__SimShader__selected__Terracotta_data(pre) ? 0.01568628 : 0.0;
    float anim = 0;
    ...
    {
        if (Terracotta__SimShader__IsValid__float(pre.r))
        {
            anim = pre.r;
            vel = Terracotta__SimShader__direction_to_vec__float(pre.r);
        }
        else
        {
            __FinalOutput.Color = float4(0.0, 0.0, 0.0, 0.0);
