...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float selected_offset = Terracotta__SimShader__selected(pre) ? 0.01568628 : 0.0;
    float anim = 0;
    ...
    {
        if (Terracotta__SimShader__IsValid(pre.r))
        {
            anim = pre.r;
            vel = Terracotta__SimShader__direction_to_vec(pre.r);
        }
        else
        {
            __FinalOutput.Color = float4(0.0, 0.0, 0.0, 0.0);
