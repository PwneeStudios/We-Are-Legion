...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__Something__Terracotta_building(building_here))
    {
        ...
        {
            float frame = 0;
            output += Terracotta__DrawBuildings__Sprite__float__Terracotta_building__Terracotta_unit__FragSharpFramework_vec2__float__FragSharpFramework_PointSampler(psin, 0.003921569, building_here, unit_here, subcell_pos, frame, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy);
        }
    }
    __FinalOutput.Color = output;
    return __FinalOutput;
