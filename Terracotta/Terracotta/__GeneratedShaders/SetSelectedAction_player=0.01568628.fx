...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (abs(unit_here.g - 0.01568628) < .001 && Terracotta__SimShader__Something(data_here) && Terracotta__SimShader__IsUnit(unit_here) && Terracotta__SimShader__selected(data_here) && fs_param_action < 0.04705882 - .001)
    {
