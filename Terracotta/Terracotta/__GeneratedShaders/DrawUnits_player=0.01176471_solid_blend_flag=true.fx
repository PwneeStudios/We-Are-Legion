...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__Something(cur) && abs(cur.g - 0.003921569) < .001)
    {
        ...
        output += Terracotta__DrawUnits__Sprite(psin, 0.01176471, pre, pre_unit, subcell_pos, frame, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy, fs_param_selection_blend, fs_param_selection_size, true, fs_param_solid_blend);
    }
    else
    {
        ...
        if (Terracotta__SimShader__IsValid(cur.r))
        {
            ...
            output += Terracotta__DrawUnits__Sprite(psin, 0.01176471, cur, cur_unit, subcell_pos + offset, frame, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy, fs_param_selection_blend, fs_param_selection_size, true, fs_param_solid_blend);
        }
        if (Terracotta__SimShader__IsValid(pre.r) && output.a < 0.025 - .001)
        {
            ...
            output += Terracotta__DrawUnits__Sprite(psin, 0.01176471, pre, pre_unit, subcell_pos + offset, frame, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy, fs_param_selection_blend, fs_param_selection_size, true, fs_param_solid_blend);
        }
    }
    __FinalOutput.Color = output;
    return __FinalOutput;
