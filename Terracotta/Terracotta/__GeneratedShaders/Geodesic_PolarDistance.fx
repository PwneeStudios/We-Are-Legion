...
float Terracotta__SimShader__polar_dist__Terracotta_geo_info(float4 info)
{
    return Terracotta__SimShader__unpack_val__FragSharpFramework_vec2(info.rg);
}
...
float3 Terracotta__SimShader__pack_vec2_3byte__FragSharpFramework_vec2(float2 v)
{
...
void Terracotta__SimShader__set_geo_pos_id__Terracotta_geo__FragSharpFramework_vec2(inout float4 g, float2 pos)
{
    g.gba = Terracotta__SimShader__pack_vec2_3byte__FragSharpFramework_vec2(pos);
}

void Terracotta__SimShader__set_polar_dist__Terracotta_geo_info__float(inout float4 info, float polar_dist)
{
    info.rg = Terracotta__SimShader__pack_val_2byte__float(polar_dist);
}
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float dist_right = Terracotta__SimShader__polar_dist__Terracotta_geo_info(tex2D(fs_param_Info, psin.TexCoords + (float2(1, 0)) * fs_param_Info_dxdy)), dist_up = Terracotta__SimShader__polar_dist__Terracotta_geo_info(tex2D(fs_param_Info, psin.TexCoords + (float2(0, 1)) * fs_param_Info_dxdy)), dist_left = Terracotta__SimShader__polar_dist__Terracotta_geo_info(tex2D(fs_param_Info, psin.TexCoords + (float2(-(1), 0)) * fs_param_Info_dxdy)), dist_down = Terracotta__SimShader__polar_dist__Terracotta_geo_info(tex2D(fs_param_Info, psin.TexCoords + (float2(0, -(1))) * fs_param_Info_dxdy));
    ...
    Terracotta__SimShader__set_geo_pos_id__Terracotta_geo__FragSharpFramework_vec2(temp_geo, pos);
    ...
    Terracotta__SimShader__set_polar_dist__Terracotta_geo_info__float(output, dist);
