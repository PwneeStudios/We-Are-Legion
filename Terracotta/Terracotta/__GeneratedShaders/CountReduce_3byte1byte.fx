...
float Terracotta__SimShader__unpack_val__FragSharpFramework_vec3(float3 packed)
{
    float coord = 0;
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float count_3byte = Terracotta__SimShader__unpack_val__FragSharpFramework_vec3(TL.xyz) + Terracotta__SimShader__unpack_val__FragSharpFramework_vec3(TR.xyz) + Terracotta__SimShader__unpack_val__FragSharpFramework_vec3(BL.xyz) + Terracotta__SimShader__unpack_val__FragSharpFramework_vec3(BR.xyz);
    float count_1byte = TL.w + TR.w + BL.w + BR.w;
    float4 output = float4(0, 0, 0, 0);
    output.xyz = Terracotta__SimShader__pack_coord_3byte__float(count_3byte);
