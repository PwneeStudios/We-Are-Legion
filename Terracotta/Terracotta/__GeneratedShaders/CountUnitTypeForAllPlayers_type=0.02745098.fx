...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__Something__Terracotta_data(data_here))
    {
        ...
        if (abs(unit_here.r - 0.02745098) < .001 && !((Terracotta__SimShader__IsUnit__float(0.02745098) && abs(unit_here.a - 0.07058824) < .001)) && !((Terracotta__SimShader__IsBuilding__float(0.02745098) && !(Terracotta__SimShader__IsCenter__Terracotta_building(data_here)))))
        {
