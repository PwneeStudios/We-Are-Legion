...
void Terracotta__SimShader__set_select_state__Terracotta_data__float(inout float4 u, float state)
{
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__selected__Terracotta_data(d))
    {
        Terracotta__SimShader__set_select_state__Terracotta_data__float(d, 0.3764706);
    }
    else
    {
        Terracotta__SimShader__set_select_state__Terracotta_data__float(d, 0.0);
    }
