...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__Something(building_here) && Terracotta__SimShader__IsBuilding(unit_here) && Terracotta__SimShader__IsCenter(building_here))
    {
        ...
        if (!(Terracotta__SimShader__selected(building_here)))
        {
            bool is_selected = Terracotta__SimShader__selected(right) || Terracotta__SimShader__selected(up) || Terracotta__SimShader__selected(left) || Terracotta__SimShader__selected(down) || Terracotta__SimShader__selected(up_right) || Terracotta__SimShader__selected(up_left) || Terracotta__SimShader__selected(down_right) || Terracotta__SimShader__selected(down_left);
            Terracotta__SimShader__set_selected(building_here, is_selected);
        }
    }
    __FinalOutput.Color = building_here;
    return __FinalOutput;
