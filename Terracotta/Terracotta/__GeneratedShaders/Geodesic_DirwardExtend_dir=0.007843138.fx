...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (geo_here.r > 0 + .001 && Terracotta__SimShader__IsBlockingTile(tex2D(fs_param_Tiles, psin.TexCoords + (Terracotta__SimShader__dir_to_vec(0.007843138)) * fs_param_Tiles_dxdy)))
    {
        output = dirward_here;
