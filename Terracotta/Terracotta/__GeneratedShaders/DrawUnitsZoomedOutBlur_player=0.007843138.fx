...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    output = 0.5 * 0.25 * (Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(0.007843138, data_right, unit_right) + Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(0.007843138, data_up, unit_up) + Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(0.007843138, data_left, unit_left) + Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(0.007843138, data_down, unit_down)) + 0.5 * Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(0.007843138, data_here, unit_here);
