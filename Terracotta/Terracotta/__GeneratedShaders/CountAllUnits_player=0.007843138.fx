...
float4 Terracotta__SimShader__to_building__Terracotta_data(float4 d)
{
    return d;
}
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__Something__Terracotta_data(data_here))
    {
        ...
        bool valid = (abs(0.007843138 - 0.0) < .001 || abs(unit_here.g - 0.007843138) < .001) && (!(fs_param_only_selected) || Terracotta__SimShader__fake_selected__Terracotta_data(data_here));
        if ((Terracotta__SimShader__IsUnit__Terracotta_unit(unit_here) || Terracotta__SimShader__IsBuilding__Terracotta_unit(unit_here) && Terracotta__SimShader__IsCenter__Terracotta_building(Terracotta__SimShader__to_building__Terracotta_data(data_here))) && valid)
        {
