...
float2 Terracotta__SimShader__ReducedGeoId__FragSharpFramework_vec2(float2 p)
{
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    geo_here.ba = Terracotta__SimShader__ReducedGeoId__FragSharpFramework_vec2(Terracotta__SimShader__geo_pos_id__Terracotta_geo(geo_here));
    geo_here.g = 0.0;
