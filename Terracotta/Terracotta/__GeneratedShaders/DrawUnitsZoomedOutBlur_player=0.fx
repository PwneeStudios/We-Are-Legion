...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    output = 0.5 * 0.25 * (Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(psin, 0, data_right, unit_right) + Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(psin, 0, data_up, unit_up) + Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(psin, 0, data_left, unit_left) + Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(psin, 0, data_down, unit_down)) + 0.5 * Terracotta__DrawUnits__Presence__float__Terracotta_data__Terracotta_unit(psin, 0, data_here, unit_here);
