...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (geo_here.r > 0 + .001 && Terracotta__SimShader__IsBlockingTile__Terracotta_tile(tex2D(fs_param_Tiles, psin.TexCoords + (Terracotta__SimShader__dir_to_vec__float(0.003921569)) * fs_param_Tiles_dxdy)))
    {
        output = dirward_here;
