...
float4 Terracotta__DrawDebugInfo__DrawDebugArrow__float__FragSharpFramework_vec2__FragSharpFramework_PointSampler(VertexToPixel psin, float dir, float2 pos, sampler Texture, float2 Texture_size, float2 Texture_dxdy)
{
    return Terracotta__DrawDebugInfo__DrawDebugInfoTile__float__float__FragSharpFramework_vec2__FragSharpFramework_PointSampler__FragSharpFramework_vec2(psin, 0.0, FragSharpFramework__FragSharpStd__Float__float(dir - 0.003921569), pos, Texture, Texture_size, Texture_dxdy, float2(1.0 / 32, 1.0 / 4));
}
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (here.r > 0.0 + .001)
    {
        ...
        output.a = 1.0;
        output.rgb *= output.a;
        output *= Terracotta__DrawDebugInfo__DrawDebugArrow__float__FragSharpFramework_vec2__FragSharpFramework_PointSampler(psin, here.r, subcell_pos, fs_param_Texture, fs_param_Texture_size, fs_param_Texture_dxdy);
    }
