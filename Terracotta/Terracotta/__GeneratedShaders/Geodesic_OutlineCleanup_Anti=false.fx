...
bool Terracotta__SimShader__IsBlockingTile__Terracotta_tile(float4 t)
{
...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(here))
    {
        __FinalOutput.Color = float4(0, 0, 0, 0);
        return __FinalOutput;
    }
    float4 output = geo_here;
    if (!((Terracotta__SimShader__IsBlockingTile__Terracotta_tile(right) && Terracotta__SimShader__IsBlockingTile__Terracotta_tile(left))) && (abs(geo_here.r - 0.007843138) < .001 && abs(geo_up.r - 0.01568628) < .001 || abs(geo_here.r - 0.01568628) < .001 && abs(geo_down.r - 0.007843138) < .001))
    {
        output.r = Terracotta__SimShader__IsBlockingTile__Terracotta_tile(right) ? 0.01176471 : 0.003921569;
    }
    if (!((Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up) && Terracotta__SimShader__IsBlockingTile__Terracotta_tile(down))) && (abs(geo_here.r - 0.003921569) < .001 && abs(geo_right.r - 0.01176471) < .001 || abs(geo_here.r - 0.01176471) < .001 && abs(geo_left.r - 0.003921569) < .001))
    {
        output.r = Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up) ? 0.01568628 : 0.007843138;
    }
    if (abs(tex2D(fs_param_Geo, psin.TexCoords + (Terracotta__SimShader__dir_to_vec__float(output.r)) * fs_param_Geo_dxdy).a - 0.003921569) < .001 && abs(geo_here.a - 0.0) < .001)
    {
        output.r = Terracotta__SimShader__Reverse__float(output.r);
    }
    int surround_count = (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up) ? 1 : 0) + (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(left) ? 1 : 0) + (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(down) ? 1 : 0) + (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(right) ? 1 : 0);
