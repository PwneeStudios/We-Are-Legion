...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    {
        if (!(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(1, 0)) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(0, 1)) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(-(1), 0)) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(0, -(1))) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(1, 1)) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(-(1), 1)) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(1, -(1))) * fs_param_Building_dxdy))) || !(GpuSim__SimShader__Something(tex2D(fs_param_Building, psin.TexCoords + (float2(-(1), -(1))) * fs_param_Building_dxdy))))
        {
