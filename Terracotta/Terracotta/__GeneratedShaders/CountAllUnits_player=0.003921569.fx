...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    if (Terracotta__SimShader__Something__Terracotta_data(data_here))
    {
        ...
        bool valid = (abs(0.003921569 - 0.0) < .001 || abs(unit_here.g - 0.003921569) < .001) && (!(fs_param_only_selected) || Terracotta__SimShader__fake_selected__Terracotta_data(data_here));
