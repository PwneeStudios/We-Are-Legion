...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float state = Terracotta__SimShader__select_state__Terracotta_data(data_here);
    ...
    Terracotta__SimShader__set_select_state__Terracotta_data__float(data_here, state);
