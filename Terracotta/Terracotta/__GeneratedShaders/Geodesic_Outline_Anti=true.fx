...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    float dir = 0;
    if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up_left))
    {
        dir = true ? 0.01176471 : 0.007843138;
    }
    if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up_right))
    {
        dir = true ? 0.007843138 : 0.003921569;
    }
    if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(down_right))
    {
        dir = true ? 0.003921569 : 0.01568628;
    }
    if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(down_left))
    {
        dir = true ? 0.01568628 : 0.01176471;
    }
    if (true)
    {
        if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(right))
        {
            dir = 0.007843138;
            if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up))
            {
                dir = 0.01176471;
                if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(left))
                {
                    dir = 0.01568628;
                }
            }
        ...
        if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(up))
        {
            ...
            {
                dir = 0.01568628;
                if (Terracotta__SimShader__IsBlockingTile__Terracotta_tile(down))
                {
                    dir = 0.003921569;
                }
            }
