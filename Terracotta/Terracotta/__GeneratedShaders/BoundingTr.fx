...
PixelToFrame FragmentShader(VertexToPixel psin)
{
    ...
    __FinalOutput.Color = Terracotta__SimShader__SomethingFakeSelected__Terracotta_data(tex2D(fs_param_Data, psin.TexCoords + (float2(0, 0)) * fs_param_Data_dxdy)) ? Terracotta__SimShader__pack_vec2__FragSharpFramework_vec2(uv) : float4(0, 0, 0, 0);
